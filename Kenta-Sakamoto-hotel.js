...
function removeGuest() {//function to remove guest
  if (document.getElementById("remove")!== 0 ){
    var rem = document.getElementById("room1list"); //makes the room list into a variable
    var list = document.getElementById("room1list").length; //makes the room list into a variable
...
function removeGuest2() {
  if(document.getElementById("remove2").value !== 0){
  ...
  totalguest2--;// removes one guest value
  }
  }
function removeAll2() {
  totalguest2 = 0;
...
function removeGuest4() {
  if(document.getElementById("remove4").value !== 0){
    ...
    totalguest4--;// removes one guest value
  }
  }
function removeAll4() {
  totalguest4 = 0;
...
function removeGuest5() {
  if(document.getElementById("remove5").value !== 0){
    ...
    document.getElementById("full5").innerHTML="";
    totalguest5--;// removes one guest value
  }
  }
function removeAll5() {
  totalguest5 = 0;
